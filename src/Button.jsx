...
const Button = () => {
  return (
    <button className="relative flex items-center px-6 py-2 overflow-hidden font-medium transition-all bg-indigo-500 rounded-md group cursor-pointer mt-4 md:mt-0">
